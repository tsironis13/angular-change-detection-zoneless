...
export class Comp_1_x_1_1_Component extends AbstractChangeDetectionComponent implements AfterViewChecked {
  constructor() {
    super(NAME, LEVEL, CD_STRATEGY);
  }

  ngAfterViewChecked(): void {
    console.log("Comp_1_x_1_1_Component_ngAfterViewChecked");
  }
}
